...
এই প্রজেক্টে ৩টি বা তার বেশি Proxmox VE নোডের ক্লাস্টারে একটা **হাই-অ্যাভেইল্যাবল (HA) লোড ব্যালেন্সার** সেটআপ করা, যাতে যেকোনো একটা লোড ব্যালেন্সার সার্ভার ডাউন হয়ে গেলেও Virtual IP (VIP) ফেলওভারের মাধ্যমে সার্ভিস  চালু থাকে।
